...
const initStore = () => {
    ...
    node_fs_1.default.mkdirSync(`src/store-redux/hooks`, { recursive: true });
    ...
    node_fs_1.default.writeFileSync(`src/store-redux/store.ts`, (0, store_tamplate_1.templateMainSlice)());
    node_fs_1.default.writeFileSync(`src/store-redux/root-reducer.ts`, (0, root_reducer_1.templateRootReducer)());
    node_fs_1.default.writeFileSync(`src/store-redux/hooks/index.ts`, (0, hooks_tamplate_1.templateHooks)());
};
